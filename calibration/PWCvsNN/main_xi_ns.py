...
def train(config, true_S, type):    
    ...
    for step in range(1, config.num_iterations+1):       
        ...
        param_history.append([H.numpy(), rho.numpy(), nu.numpy(), beta_0.numpy(), beta_1.numpy(), beta_2.numpy(), ttau.numpy()])        
       
        
        np.save("FinalResult/loss_history_1_ns.npy", np.array(loss_history))
        np.save("FinalResult/param_history_1_ns.npy", np.array(param_history))
        np.save("FinalResult/xi_history_1_ns.npy", np.array(xi_history))
